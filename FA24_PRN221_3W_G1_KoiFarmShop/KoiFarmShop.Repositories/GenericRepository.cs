...
namespace KoiFarmShop.Repositories
{
    public class GenericRepository<T> where T : class
    {
        ...
        protected FA24_PRN221_3W_G1_KoiFarmShopContext _context;

        public GenericRepository()
        {
            _context ??= new FA24_PRN221_3W_G1_KoiFarmShopContext();
        }

        public GenericRepository(FA24_PRN221_3W_G1_KoiFarmShopContext context)
        {
            _context = context;
        }
